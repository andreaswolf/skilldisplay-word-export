...
use App\Export\Pdf\GotenbergPdfRenderer;
use App\Export\Pdf\SkillSetHtmlWriter;
...
#[AsCommand(
    'skilldisplay:skills-pdf-export',
    'Exports all skills as a single PDF document (A6 cards)'
)]
final class SkillsetPdfExport extends Command
{
    public function __construct(
        private readonly Settings             $skilldisplaySettings,
        private readonly Client               $client,
        private readonly SkillSetHtmlWriter   $writer,
        private readonly GotenbergPdfRenderer $pdfRenderer,
    ) {
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $pdfData = $this->writer->writeSkillsHtmlForPdf($relevantSkills, $skillDependencies);

        $pdf = $this->pdfRenderer->renderPdf($pdfData);
